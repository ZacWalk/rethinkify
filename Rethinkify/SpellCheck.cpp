...
bool SpellCheck::WordValid(const wchar_t *wword, int wlen)
{
	Platform::Lock l(_cs);
...
std::vector<std::wstring> SpellCheck::Suggest(const std::wstring &wword)
{
	Platform::Lock l(_cs);
...
void SpellCheck::AddWord(const std::wstring &wword)
{
	Platform::Lock l(_cs);
