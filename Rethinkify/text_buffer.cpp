...
text_buffer::text_buffer(const std::wstring &text, int nCrlfStyle)
{
	_modified = false;
...
void text_buffer::AppendLine(const std::wstring &text)
{
...
bool text_buffer::LoadFromFile(const std::wstring &path)
{
	clear();
...
bool text_buffer::SaveToFile(const std::wstring &path, int nCrlfStyle /*= CRLF_STYLE_AUTOMATIC*/, bool bClearModifiedFlag /*= true*/) const
{
	auto success = false;
...
std::vector<std::wstring> text_buffer::text(const text_selection &selection) const
{
...
std::vector<std::wstring> text_buffer::text() const
{
	std::vector<std::wstring> result;
...
void text_buffer::AddView(text_view *pView)
{
	_views.push_back(pView);
}

void text_buffer::RemoveView(text_view *pView)
{
...
void text_buffer::invalidate_line(int index)
{
	for (auto v : _views)
	{
		v->invalidate_line(index);
	}
}

void text_buffer::invalidate_view()
{
	for (auto v : _views)
	{
		v->invalidate_view();
...
text_location text_buffer::insert_text(const text_location &location, const std::wstring &text)
{
...
text_location text_buffer::insert_text(undo_group &ug, const text_location &location, const std::wstring &text)
{	
	text_location resultLocation = location;
...
text_location text_buffer::insert_text(const text_location &location, const wchar_t &c)
{
	text_location resultLocation = location;
...
text_location text_buffer::insert_text(undo_group &ug, const text_location &location, const wchar_t &c)
{
...
bool text_buffer::Find(const std::wstring &text, const text_location &ptStartPos, DWORD dwFlags, bool bWrapSearch, text_location *pptFoundPos)
{
...
bool text_buffer::FindInBlock(const std::wstring &what, const text_location &ptStartPosition, const text_location &ptBlockBegin, const text_location &ptBlockEnd, DWORD dwFlags, bool bWrapSearch, text_location *pptFoundPos)
{
